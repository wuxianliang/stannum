...
- [ ] WI-C: full gate re-run + commit + push both repos (stannum → origin main fork; pgembed → origin main). STANNUM_COMMIT pin bump becomes unblocked after push (follow-up, user decision).