...
**0.4.0 WAVE COMPLETE 2026-09-25.** All four P0 releases implemented + pushed: 0.2.0 (jieba governance), 0.3.0 (search + observability + pgembed_stannum), 0.4.0 (LSG4 multi-column BM25F). Follow-up: pgembed STANNUM_COMMIT pin is at 7f58bbe (0.3.0 era) — bump to 18bdd8c + bundle rebuild to ship LSG4 in pgembed, and add the pgembed_stannum field_weights kwarg when pinning 0.4.0.
