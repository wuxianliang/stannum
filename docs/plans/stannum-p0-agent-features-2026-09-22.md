...
- [ ] WI-13: step 13 — phase 3: same-field phrases, highlight overload + field fixture, fuzz/oracle field dimension, docs; release 0.4.0 SQL/version. REMAINING scope alignment (scan-side DONE in WI-12): heap-fallback full_score/build_corpus field scoping must match the scan path so custom-scan-on/off agree by scoring semantics.
